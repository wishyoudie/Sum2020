...
vi6SHADER VI6_RndShaders[VI6_MAX_SHADERS];       /* Array of shaders */
INT VI6_RndShadersSize;                          /* Shaders array store size */
